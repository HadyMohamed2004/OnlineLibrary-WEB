...
function updateNavigation() {
    ...
    navHTML += `
        ...
        <a href="/src/allBooks.html">All Books</a>
    `;
    ...
    if (role === ROLE_GUEST) {
        ...
        navHTML += `
            <a href="/src/mybooks.html">My Books</a>
            <a href="/src/wishlist.html">Wishlist</a>
            <a href="/src/userDashboard.html">My account</a>
            <a href="#" id="logout-link">Logout</a>
        `;
    } else if (role === ROLE_ADMIN) {
        // Add admin-only links
        navHTML += `
            <a href="/src/addBook.html">Add a book</a>
            <a href="/src/adminDashboard.html">Dashboard</a>
            <a href="/src/userDashboard.html">My account</a>
            <a href="#" id="logout-link">Logout</a>
        `;
    }
...
function setupSearchForm() {
    ...
    if (searchForm) {
        searchForm.addEventListener('submit', function(e) {
            ...
            // Get the current path to determine relative path to search results
            const currentPath = window.location.pathname;
            const isInSrcDir = currentPath.includes('/src/');
            const searchPath = isInSrcDir ? 'searchResults.html' : 'src/searchResults.html';
            
            // Redirect to search results page with query parameter
            if (searchQuery) {
                window.location.href = `${searchPath}?q=${encodeURIComponent(searchQuery)}`;
            } else {
